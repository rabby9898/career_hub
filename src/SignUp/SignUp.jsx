        ...
        <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
          ...
          >
            ...
            <button
              ...
              className="w-full flex bg-[#232629] justify-center items-center gap-1 border-2 border-gray rounded-lg py-2 my-3 text-white text-base"
            >
              <FaGithub className="text-xl" /> Sign up With Github
            </button>
            <button
              onClick={handleFacebookSignIn}
              className="w-full flex bg-[#314A86] justify-center items-center gap-1 border-2 border-gray rounded-lg py-2 my-3 text-white text-base"
            >
              <AiFillFacebook className="text-xl" /> Sign up With Facebook
            </button>
            <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
              Already have an account?{" "}
              <Link
                className="font-medium text-[#6465F1] transition-colors hover:text-blue-700"
                to="/login"
              >
                Sign In
              </Link>
